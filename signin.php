...
<body class="ani bg-gradient-to-b from-[#5FC4DB] to-[#C4916B] flex justify-center items-center h-screen">
    ...
    <div class="w-[50vw] h-[80vh] absolute left-[10vw] top-[20vh]">
        <form action="../backendLogics/signin_backend.php" method="post" class="invisible ani1 text-2xl">
            ...
            <input type="text" id="username" placeholder="Name" name="username" autocomplete="off" class="block py-[1.25rem] px-[7vw] my-[4vh] rounded-[40px] bg-[#D9D9D9]">
            ...
            <input type="text" id="contact" placeholder="Contact" name="contact" autocomplete="off" class="block py-[1.25rem] px-[7vw] my-[4vh] rounded-[40px] bg-[#D9D9D9]">
