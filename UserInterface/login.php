...
<body class="ani bg-green-200 flex justify-center items-center h-screen">
    <p class="invisible ani1 absolute top-[10vh] text-3xl text-green-400" style="font-family: cursive;">Login And Work as a team</p>
    <div class="w-[40vw] h-[80vh] absolute left-[55vw] flex items-center justify-center">
        <form action="../backendLogics/login_backend.php" method="post" class="invisible ani1 text-2xl pl-[2vw]">
            <p class="invisible ani1 absolute left-[18vw] top-[17vh] text-3xl text-green-400" style="font-family: cursive;">Log In</p>
